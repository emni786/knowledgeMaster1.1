...
export const Route = createFileRoute("/_authenticated/settings")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Manage your Xenonowledge account and preferences." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Manage your Xenonowledge account and preferences.</p>
      </main>
    </div>
  );
}
