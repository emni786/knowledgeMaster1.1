...
export const Route = createFileRoute("/_authenticated/dashboard")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Overview of your link library activity." },
    ],
  }),
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        <h2 className="font-display text-3xl font-semibold">Activity overview</h2>
        <p className="mt-2 text-sm text-muted-foreground">High-level stats coming soon.</p>
      </main>
    </div>
  );
}
