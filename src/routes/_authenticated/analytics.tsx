...
export const Route = createFileRoute("/_authenticated/analytics")({
  head: () => ({
    meta: [
      { title: "Analytics — Xenonowledge" },
      { name: "description", content: "Insights into your reading and saving habits." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Insights into your reading and saving habits.</p>
      </main>
    </div>
  );
}
