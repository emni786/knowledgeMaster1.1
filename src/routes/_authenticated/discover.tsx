...
export const Route = createFileRoute("/_authenticated/discover")({
  head: () => ({
    meta: [
      { title: "Discover — Xenonowledge" },
      { name: "description", content: "Trending and suggested links from your library." },
    ],
  }),
  component: Page,
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-5xl px-6 py-10">
        <h2 className="font-display text-3xl font-semibold">Discover</h2>
        <p className="mt-2 text-sm text-muted-foreground">Trending and suggested links from your library.</p>
      </main>
    </div>
  );
}
